...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM general_fam WHERE client_id = $client_id AND fam_no = 1";
			if ($result=mysqli_query($con,$sql)) {
...
td, th {
	...
	<input style='width: 250px; border: none; border-bottom: 1px solid black; text-align: center;' value='$family_head' type='text' />
