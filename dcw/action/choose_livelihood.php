...
if(isset($_POST['submit'])){
		...
		// Service inputs
		$choice1 = ucfirst(strtolower($_POST["choice1"]));
		$choice2 = ucfirst(strtolower($_POST["choice2"]));
		$choice3 = ucfirst(strtolower($_POST["choice3"]));
		$startup = ucfirst(strtolower($_POST["startup"]));
		...
		$stmt->close();
			...
			$sql = " INSERT INTO activity_log ( activity_date, details )
						 VALUES ( now() , ' $worker_name registered Existing Client named $firstname $lastname in Livelihood Assistance' )";
