...
$proaddErr = $educErr = $skillErr = $incomeErr = $admissionErr = $family_headErr = $positionErr = $assestmentErr = $amountErr = "";

// Required variables
$firstname = $middlename = $lastname = $sex = $bday = $bplace = $civil = $preadd = $barangay = "";
$proadd = $educ = $skill = $income = $admission = $family_head = $position = $assestment = $amount = "";
...
$contactno = $_POST["contactno"];
  ...
  if (empty($_POST["admission"])) {
    $admissionErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $admission = user_input($_POST["admission"]);
  }
  ...
  if (empty($_POST["amount"])) {
    $amountErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $amount = user_input($_POST["amount"]);
  }
