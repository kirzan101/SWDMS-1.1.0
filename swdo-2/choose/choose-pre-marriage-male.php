            ...
            <div class="x_panel">
			  ...
			  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"].''.$client);?>">
				...
				<div class="row" >
				  ...
				  <div class="col-md-8 col-sm-12 col-xs-12 form-group">
                    <label for="family_head">Family Head * :</label>
						<input type="text" class="form-control" name="family_headm" placeholder="Family Head" onkeypress="return validateKeyStroke(event)" maxlength="50" value="<?php echo $family_headm;?>" readonly  >
						<span class="error"> <?php echo $family_headmErr;?></span>
				  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="position">Position in the Family * :</label>
						<input type="text" class="form-control" name="positionm" placeholder="Position" onkeypress="return validateKeyStroke(event)" maxlength="50" value="<?php echo $positionm;?>" readonly  >
				...
				<p style="font-weight: bold; color: blue;" >Woman (Babae)</p>
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
				    <label for="name">First Name * :</label>
                    <input type="text" name="firstnamef" placeholder="First Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $firstnamef;?>"  >
					<span class="error"> <?php echo $firstnamefErr;?></span>
                  </div>

                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Middle Name * :</label>
					<input type="text" name="middlenamef" placeholder="Middle Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $middlenamef;?>"  >
					<span class="error"> <?php echo $middlenamefErr;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Last Name * :</label>
					<input type="text" name="lastnamef" placeholder="Last Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $lastnamef;?>"  >
				  ...
				  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Birthplace * :</label>
					<input type="text" name="bplacef" placeholder="Birthplace" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $bplacef;?>"   >
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label for="preadd">Present Address * :</label>
					<input type="text" name="preaddf" placeholder="Present Address" class="form-control" maxlength="50" value="<?php echo $preaddf;?>"  >
					<p><i>No./ Building / Street / City/Municipality / District/Province / Region</i></p>
				  ...
				  <div class="col-md-5 col-sm-4 col-xs-12 form-group">
                    <label for="proadd">Provincial Address * :</label>
					<input type="text" name="proaddf" placeholder="Provincial Address" value="Camarines Sur" class="form-control" onkeypress="return validateKeyStroke(event)" maxlength="30" value="<?php echo $proaddf;?>"   >
				...
				<div class="row" >
				  ...
				  <div class="col-md-8 col-sm-12 col-xs-12 form-group">
                    <label for="family_head">Family Head * :</label>
						<input type="text" class="form-control" name="family_headf" placeholder="Family Head" onkeypress="return validateKeyStroke(event)" maxlength="50" value="<?php echo $family_headf;?>"  >
