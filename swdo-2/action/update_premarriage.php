<?php
	...
	if(isset($_POST['submit'])){
		...
		$details = '$worker_name updated Client details named $firstnamem $lastnamem & $firstnamef $lastnamef in Pre-marriage';
		...
		// Insert to Activity Log
			$stmt = $con->prepare("INSERT INTO activity_log ( activity_date, details ) VALUES (now(),?)");
