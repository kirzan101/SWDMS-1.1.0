              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  ?>
							...
							<td><center>N/A</center></td>
							<td><center>N/A</center></td>
							<td><?php if ($row8['service_id'] == '8') { echo '<center><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#other1"><span class="fa fa-edit"> Select</span></button></center>'; } else { echo '<center>N/A</center></center>'; } ?></td>
						</tr>
						<tr>
				  <?php
					include "../../db_connect.php";
				 ...
				 <?php
				  ...
				  ?>
							...
							<td><center>N/A</center></td>
							<td><center>N/A</center></td>
							<td><?php if ($row14['service_id'] == '13') { echo '<center><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#other2"><span class="fa fa-edit"> Select</span></button></center>'; } else { echo '<center>N/A</center></center>'; } ?></td>
						</tr>
						<tr>
				  <?php
					include "../../db_connect.php";
				  ...
				  ?>
							...
							<td><center>N/A</center></td>
							<td><center>N/A</center></td>
							<td><?php if ($row15['service_id'] == '14') { echo '<center><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#other3"><span class="fa fa-edit"> Select</span></button></center>'; } else { echo '<center>N/A</center></center>'; } ?></td>
						</tr>
                      </tbody>
                    </table>
                  </div>
