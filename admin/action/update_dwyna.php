...
if(isset($_POST['submit'])){
		...
		$stmt->close();
			...
			$stmt = $con->prepare("UPDATE client_dwyna_details SET type_of_abuse = ?, parent_name = ?, when_happened = ?, where_happned = ?, perpetrator = ?, services_rendered, disposition = ? WHERE interview_id = ?");
			...
			if($con->multi_query($sql)){
				...
				echo '<script>alert("Client Unsuccessfully Registered");location="../update/update-dwyna.php";</script>';
			}
