<?php 
session_start();
if($_SESSION['user_type'] != 'A' || $_SESSION['user_type'] == NULL){
...
if ($password == md5('admin') OR $password == md5('DEFAULT123') ) {
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a href="index.php" ><i class="fa fa-users"></i> Manage Accounts</a>
				  </li>
				  <li><a href="http://localhost/phpmyadmin/" target="_blank" ><i class="fa fa-database"></i> Manage Database</a>
				  </li>
                </ul>
              </div>
