<?php
	...
	// Query for indigency services
	$sql = "SELECT * FROM client c LEFT JOIN client_general_details g ON c.client_id = g.client_id LEFT JOIN assistance a ON c.client_id = a.client_id LEFT JOIN client_indigency_details d ON c.client_id = d.client_id 
	...
	// client_indigency_details Table
