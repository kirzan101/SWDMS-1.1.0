<?php
	...
	// Query for referral services
	$sql = "SELECT * FROM client c LEFT JOIN client_general_details g ON c.client_id = g.client_id LEFT JOIN assistance a ON c.client_id = a.client_id LEFT JOIN client_referral_details d ON c.client_id = d.client_id 
	...
	// client_referral_details Table
	$referral_details = $row['referral_details'];
	$referral_letter_details = $row['referral_letter_details'];
