		...
		<!-- SQL Insert file -->
		<?php if ($countErr == 1 OR $countErrs == 1) { echo ""; } else { include '../action/update_dwyna.php'; } ?>
            ...
            <div class="x_panel">
			  ...
			  <!-- Hidden values -->
				...
				<!-- Hidden values: Please Ignore -->
				   ...
				   <input type="text" name="reff1" hidden value=""  />
				   <input type="text" name="reff2" hidden value="" />
                   <input type="text" name="house" hidden value=""/> 
                   <input type="text" name="lot" value="" hidden/> 
                   <input type="text"  name="areff1" value="" hidden /> 
                   <input type="text" name="areff2" value="" hidden /> 
				   <input type="text" name="assestment" value="" hidden /> 
