...
if(isset($_POST['submit'])){
		...
		$stmt->close();
			...
			$sql = " INSERT INTO activity_log ( activity_date, details )
						 VALUES ( now() , ' $worker_name registered Existing Client named $firstname $lastname in AICS - $service_name' )";
			...
			if($con->multi_query($sql)){
				...
				echo '<script>alert("Client Unsuccessfully Registered");location="../choose/choose-aics.php";</script>';
			}
