		<!-- Page Header -->
		<?php include '../forms/form-header.php'; ?>
		
		<!-- Get Client ID -->
		<?php $client_id = $_GET['client_id']; ?>
		
		<!-- Error Handling -->
		<?php include 'edit-error-details.php'; ?>
		
		<!-- Query Client Details-->
		<?php include 'edit-query-details.php'; ?>
		
		<!-- Query Client family -->
		<?php include 'edit-query-fam.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include 'edit-update-details.php'; } ?>
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2><b>Update Client<?php echo $countErr; ?></b></h2>				  
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    ...
                    <input type="text" name="firstname" placeholder="First Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $firstname;?>" required>
					<span class="error"> <?php echo $firstnameErr;?></span>
                  </div>

                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Middle Name * :</label>
					<input type="text" name="middlename" placeholder="Middle Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $middlename;?>" required>
					<span class="error"> <?php echo $middlenameErr;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Last Name * :</label>
					<input type="text" name="lastname" placeholder="Last Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $lastname;?>" required>
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
					...
					<div class='input-group date' type="date" id='myDatepicker2'>
                            <input type='text' class="form-control" name="bday" id="bday" value="<?php if (empty($bday)) { echo "".date("m/d/y").""; } else { echo date('m/d/y', strtotime($bday)); } ?>" onblur="submitBday()" onkeyup="submitBday()" required />
				  ...
				  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
					...
					<input type="text" name="bplace" placeholder="Birthplace" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $bplace;?>"  required>
				 ...
				 <div class="col-md-4 col-sm-12 col-xs-12 form-group">
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="barangay">Barangay * :</label>
						<select class="select2_single form-control" name="barangay" tabindex="-1" required>
                            <option></option>
				  ...
				  <div class="col-md-9 col-sm-12 col-xs-12 form-group">
					...
					<input type="text" name="preadd" placeholder="Present Address" class="form-control" maxlength="50" value="<?php echo $preadd;?>" required>
				...
				<div class="row" >
				  ...
				  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                    <label for="family_head">Family Head * :</label>
						<input type="text" class="form-control" name="family_head" placeholder="Family Head" onkeypress="return validateKeyStroke(event)" maxlength="50" value="<?php echo $family_head;?>" required>
		...
		<?php include '../forms/form-footer.php'; ?>