          ...
          <table class="table table-hover">
			...
			<?php while($rows = mysqli_fetch_array($result)) { ?>
			  <tr>
				...
				<td><a class="btn btn-danger btn-xs" href="../action/delete_burial.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_general_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			  </tr>
			<?php } ?>
			</tbody>
		  </table>
		...
		?>
          ...
          <table class="table table-hover">
			...
			<?php while($rows = mysqli_fetch_array($result)) { ?>
			  <tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_educational.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_general_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			  </tr>
			<?php } ?>
			</tbody>
		  </table>
		...
		?>
          ...
          <table class="table table-hover">
			...
			<?php while($rows = mysqli_fetch_array($result)) { ?>
			  <tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_food.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_general_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			  </tr>
			<?php } ?>
			</tbody>
		  </table>
		...
		?>
          ...
          <table class="table table-hover">
			...
			<?php while($rows = mysqli_fetch_array($result)) { ?>
			  <tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_medical.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_general_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			  </tr>
			<?php } ?>
			</tbody>
		  </table>
		...
		?>
          ...
          <table class="table table-hover">
			...
			<?php while($rows = mysqli_fetch_array($result)) { ?>
			  <tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_transportation.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_general_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			  </tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_cicl.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_child_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_dwyna.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_dwyna_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_pre_marriage.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_premarriage_detail_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_solo-parent.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_solo_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_pwd.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['pwd_solo_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_dascpd.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_death_aid_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_livelihood.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_training_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_rloa.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_referral_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_scsr.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_scsr_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
      ...
      <div class="modal-content">
		...
		?>
          ...
          <table class="table table-hover">
			...
			<tr>
				<td><?php $dmy = date("M d,Y", strtotime($rows['interview_date'])); echo $dmy; ?> | <?php $time = date("h:i A", strtotime($rows['interview_time'])); echo $time; ?></td>
				<td><a class="btn btn-danger btn-xs" href="../action/delete_indigency.php?client_id=<?php echo $rows['client_id']; ?>&&count=<?php echo $rows['client_indigency_detail_id']; ?>&&assistance_id=<?php echo $rows['assistance_id']; ?>&&interview_id=<?php echo $rows['interview_id']; ?>" >Delete</a></td>
			</tr>
			<?php } ?>
			</tbody>
		  </table>
